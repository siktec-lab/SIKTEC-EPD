...
public:
    ...
    */
    ...
    ) : SIKTEC_EPD(EPD_3CS_WIDTH, EPD_3CS_HEIGHT, CS, SRCS, DC, RST, BUSY, spi_clock, spi_miso, spi_mosi) {
        this->_init();
    }
    /** 
     * @brief The SIKTEC EPD constructor when you you define your own SPI pins.
    ...
    */
    inline SIKTEC_EPD_3CS(
        ...
        int8_t spi_clock, int8_t spi_miso,  int8_t spi_mosi
    ) : SIKTEC_EPD(EPD_3CS_WIDTH, EPD_3CS_HEIGHT, pins, spi_clock, spi_miso, spi_mosi) {
        this->_init();
    }
    ...
    */
    inline SIKTEC_EPD_3CS(
        int8_t CS, int8_t SRCS, int8_t DC, int8_t RST, int8_t BUSY
    ) : SIKTEC_EPD(EPD_3CS_WIDTH, EPD_3CS_HEIGHT, CS, SRCS, DC, RST, BUSY) {
        this->_init();
    }
     ...
     * @param pins  the epd & sram pins
    */
    inline SIKTEC_EPD_3CS(const epd_pins_t &pins) : SIKTEC_EPD(EPD_3CS_WIDTH, EPD_3CS_HEIGHT, pins) {
        this->_init();
    }
